 ...
 * @Created 2021/10/12
 */
public class JScrollPaneDemo4 {

    public static void main(String[] args) {
        FlatLightLaf.setup();
//        arc-theme-orange.theme.json
        String theme = "/arc_theme_dark.theme.json";
        IntelliJTheme.setup(JScrollPaneDemo4.class.getResourceAsStream(theme));
        ...
        for (int i = 0; i < 10; i++) {
            ...
            JPanel line0 = new JPanel(new GridLayout(2, 1));
            line0.setPreferredSize(new Dimension(200, 80));
            line0.add(textArea);
            line0.add(new Button(i + ":label"));
            line0.setBorder(new LineBorder(Color.GRAY, 1));
        ...
        for (int i = 0; i < 20; i++) {
            ...
            Box line0 = Box.createVerticalBox();//new JPanel(new GridLayout(2, 1));
            line0.setPreferredSize(new Dimension(300, 40));
            line0.add(textArea);
            line0.add(new Button(i + ":label"));
            line0.setBorder(new LineBorder(Color.GRAY, 1));
