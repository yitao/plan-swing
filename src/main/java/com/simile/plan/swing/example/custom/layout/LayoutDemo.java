...
public class LayoutDemo {
    ...
    public static void main(String[] args) {
        ...
        line1.setPreferredSize(new Dimension(400,200));
        line1.setBorder(new LineBorder(Color.GRAY));
        line1.add(new Label("第一行"));
        panel.add(line1);

        JPanel line11 = new JPanel();
        line11.setBorder(new LineBorder(Color.GRAY));
        line11.add(new Label("第一1行"));
        panel.add(line11);
        ...
        line3.add(new JButton("第3.1行"));
        line3.add(new JButton("第3.2行"));
        panel.add(line3);
